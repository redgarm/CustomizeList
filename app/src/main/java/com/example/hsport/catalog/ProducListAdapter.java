...
/**
 * Created by iserm on 17/02/16.
 */
public class ProducListAdapter extends ArrayAdapter<Product> {

    private List<Product> products;


    public ProducListAdapter(Context context, int resource, List<Product> objects) {
